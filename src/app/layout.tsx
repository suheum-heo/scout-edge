        ...
        <ThemeProvider>
          ...
          <nav className="border-b border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-950/80 backdrop-blur-sm sticky top-0 z-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
                ...
                <span className="hidden sm:inline text-slate-400 dark:text-slate-500 text-xs border border-slate-300 dark:border-slate-700 px-1.5 py-0.5 rounded">BETA</span>
              </Link>
              ...
              <div className="flex items-center gap-1">
                ...
                <Link href="/verdict" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white text-sm px-3 py-1.5 rounded-lg hover:bg-[#EEF2F7] dark:hover:bg-slate-800 transition-colors">
                  Verdict
                </Link>
                <Link href="/build" className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white text-sm px-3 py-1.5 rounded-lg hover:bg-[#EEF2F7] dark:hover:bg-slate-800 transition-colors">
                  Build XI
                </Link>
                <ThemeToggle />
              </div>
          ...
          <footer className="border-t border-slate-200 dark:border-slate-800 mt-20 py-8">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
              <p className="text-slate-400 dark:text-slate-600 text-sm">ScoutEdge · Tactical Transfer Intelligence · Powered by Claude AI</p>
              <p className="text-slate-300 dark:text-slate-700 text-xs mt-1">Player data via API-Football. For scouting and analytical purposes.</p>
            </div>
          </footer>
        </ThemeProvider>
      </body>
